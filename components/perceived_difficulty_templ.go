...
func PerceivedDifficulty(grade string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div class=\"flex flex-col items-center relative\"><button hx-get=\"/log/grade\" hx-target=\"#main-content\" class=\"mb-4 bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center\"><i class=\"fas fa-arrow-left mr-2\"></i> Back</button><h2 class=\"text-2xl font-bold mb-4\">Boulder Grade: ")
		if templ_7745c5c3_Err != nil {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `components/perceived_difficulty.templ`, Line: 16, Col: 60}
		}
		...
		for i := 1; i <= 8; i++ {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `components/perceived_difficulty.templ`, Line: 20, Col: 57}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `components/perceived_difficulty.templ`, Line: 34, Col: 31}
			}
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</div><button class=\"absolute top-0 right-0 bg-blue-500 text-white rounded-full w-8 h-8 flex items-center justify-center\" onclick=\"toggleInfoPopup()\"><i class=\"fas fa-info\"></i></button><div id=\"infoPopupOverlay\" class=\"fixed inset-0 bg-black bg-opacity-50 hidden\" onclick=\"toggleInfoPopup()\"></div><div id=\"infoPopup\" class=\"hidden fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white border border-gray-300 p-4 rounded shadow-lg w-3/4 max-w-xs z-10\"><h3 class=\"font-bold mb-2\">Perceived Difficulty Scale</h3><ul class=\"list-disc pl-5\"><li>1 - (Topped) flash very easily</li><li>2 - (Topped) flash with some difficulty</li><li>3 - (Topped) flash with a lot of difficulty</li><li>4 - (Topped) topped with a lot of difficulty and multiple attempts</li><li>5 - (Not topped) very close to topping, maybe next time</li><li>6 - (Not topped) could do all moves separately but not together</li><li>7 - (Not topped) some moves just could not be done</li><li>8 - (Not topped) couldn't do any moves</li></ul></div></div><script>\n\t\tfunction toggleInfoPopup() {\n\t\t\tconst popup = document.getElementById('infoPopup');\n\t\t\tconst overlay = document.getElementById('infoPopupOverlay');\n\t\t\tpopup.classList.toggle('hidden');\n\t\t\toverlay.classList.toggle('hidden');\n\t\t}\n\t</script>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return templ_7745c5c3_Err
