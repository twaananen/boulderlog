...
func DifficultyProgressionChart(grades []string, data map[string][]struct {
	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div id=\"difficulty-progression-chart\" class=\"bg-white dark:bg-gray-800 p-4 rounded-lg shadow-lg\"><div class=\"max-h-96 min-h-64\"><canvas id=\"difficultyProgressionCanvas\" data-grades=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
