...
type Database interface {
	...
	SaveBoulderLog(log *models.BoulderLog) (*models.BoulderLog, error)
	...
	GetBoulderLogByID(username string, logID uint) (*models.BoulderLog, error)
	UpdateBoulderLog(log *models.BoulderLog) (*models.BoulderLog, error)
	DeleteBoulderLog(username string, logID uint) error
}
